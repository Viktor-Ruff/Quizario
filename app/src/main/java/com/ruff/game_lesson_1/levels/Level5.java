...
public class Level5 extends AppCompatActivity {
    ...
    private void initLivesDialog() {
        ...
        restore.setOnClickListener(v -> {
            ...
            myRewardedAd.showRewardedAd(Level5.this, binding.tvHeartCounter);
            dialogLives.cancel();
            myRewardedAd.loadRewardedAd(this);
        });
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (slider.getValue() == slider.getValueTo()) {
                        ...
                        if (levelCounter <= 5) { //если кол-во пройденных уровней 1 или меньше
                            saveProgress = getProgress.edit();
                            saveProgress.putInt(LEVEL_KEY, 6); //сохраняем в файл значение 2
                            saveProgress.apply();
                        }
