...
public class Level18 extends AppCompatActivity {
    ...
    int[] swimAnimalArray;
    String[] swimAnimalTextArray;
    int[] notSwimAnimalArray;
    String[] notSwimAnimalTextArray;
    int order;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swimAnimalArray = new int[]{R.drawable.im_dolphin, R.drawable.im_jellyfish, R.drawable.im_killer_whale,
                R.drawable.im_octopus, R.drawable.im_seal, R.drawable.im_walrus, R.drawable.im_turtle,
                R.drawable.im_goose, R.drawable.im_crocodile, R.drawable.im_platypus, R.drawable.im_gold_fish,
                R.drawable.im_penguin};

        notSwimAnimalArray = new int[]{R.drawable.im_squirrel, R.drawable.im_ant, R.drawable.im_cat,
                R.drawable.im_owl, R.drawable.im_snail, R.drawable.im_spider, R.drawable.im_hen,
                R.drawable.im_chameleon, R.drawable.im_butterfly, R.drawable.im_chafer,
                R.drawable.im_grasshopper, R.drawable.im_ladybug, R.drawable.im_mantis, R.drawable.im_peacock};
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (slider.getValue() == slider.getValueTo()) {
                        ...
                        if (levelCounter <= 18) { //если кол-во пройденных уровней 1 или меньше
                            saveProgress = getProgress.edit();
                            saveProgress.putInt(LEVEL_KEY, 19); //сохраняем в файл значение 2
                            saveProgress.apply();
                        }
    ...
    public void initCardViews() {
        ...
        swimAnimalTextArray = getResources().getStringArray(R.array.swim_animal_array);
        notSwimAnimalTextArray = getResources().getStringArray(R.array.not_swim_animal_array);


        Random random = new Random();
        order = random.nextInt(2);
        leftNumCard = random.nextInt(swimAnimalArray.length);
        rightNumCard = random.nextInt(notSwimAnimalArray.length);

        if (order > 0) {
            binding.tvLeftNumber.setBackgroundResource(swimAnimalArray[leftNumCard]);
            binding.tvRightNumber.setBackgroundResource(notSwimAnimalArray[rightNumCard]);
            binding.tvLeftNumberText.setText(swimAnimalTextArray[leftNumCard]);
            binding.tvRightNumberText.setText(notSwimAnimalTextArray[rightNumCard]);
        } else {
            binding.tvRightNumber.setBackgroundResource(swimAnimalArray[leftNumCard]);
            binding.tvLeftNumber.setBackgroundResource(notSwimAnimalArray[rightNumCard]);
            binding.tvRightNumberText.setText(swimAnimalTextArray[leftNumCard]);
            binding.tvLeftNumberText.setText(notSwimAnimalTextArray[rightNumCard]);
        }
    }
